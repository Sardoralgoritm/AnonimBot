...
class Program
{
    public static async Task Main(string[] args)
    {
        ...
        async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            Console.WriteLine($"Written Firstname: {RemoveNonAlphanumeric(message.Chat.FirstName)}\nLastname: {RemoveNonAlphanumeric(message.Chat.LastName)}\nUsername: {RemoveNonAlphanumeric(message.Chat.Username)}\nMessage: {messageText}");
        }
